...
//		}
	...
	public void addDummyUserData(List<MatchingPerson> matchingPersonList,
		...
		mPerson1.setLatitude(sampleLocation.getLatitude() + .001);
		mPerson1.setLongitude(sampleLocation.getLongitude() + .001);
		...
		mPerson2.setLatitude(sampleLocation.getLatitude() + .002);
		mPerson2.setLongitude(sampleLocation.getLongitude() + .002);
		...
		mPerson3.setLatitude(sampleLocation.getLatitude() + .003);
		mPerson3.setLongitude(sampleLocation.getLongitude() + .003);
